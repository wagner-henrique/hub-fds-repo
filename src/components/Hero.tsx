    ...
    >
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="#home" className="text-sm font-medium hover:text-primary transition-colors">Início</Link>
          <Link href="#espacos" className="text-sm font-medium hover:text-primary transition-colors">Espaços</Link>
          <Link href="#reserva" className="text-sm font-medium hover:text-primary transition-colors">Reservas</Link>
